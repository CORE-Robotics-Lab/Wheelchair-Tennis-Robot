#ifndef CUSTOM_ODRIVE_H
#define CUSTOM_ODRIVE_H

#include <Arduino.h>
#include <HardwareSerial.h>
#include "custom_print.h"

// Set up serial pins for the ODrive
HardwareSerial &odrive_serial = Serial1; // TX: 1, RX: 0

// Write a single velocity
void odrive_write_velocity(int motor, float velocity)
{
    odrive_serial.print("v ");
    odrive_serial.print(motor);
    odrive_serial.print(' ');
    odrive_serial.print(velocity);
    odrive_serial.print('\n');
}

// Write both velocities
void odrive_write_velocities(float velocity0, float velocity1)
{
    odrive_write_velocity(0, velocity0);
    odrive_write_velocity(1, velocity1);
}

// Request position and velocity of a specified motor
void odrive_request_feedback(int motor)
{
    odrive_serial.print("f ");
    odrive_serial.print(motor);
    odrive_serial.print('\n');
}

// Write a state of a motor
void odrive_request_state(int motor, int state)
{
    odrive_serial.print("w axis");
    odrive_serial.print(motor);
    odrive_serial.print(".requested_state ");
    odrive_serial.print(state);
    odrive_serial.print('\n');
}
...
void odrive_zero()
{
    odrive_serial.print("esl 0 0");
    odrive_serial.print('\n');
    odrive_serial.print("esl 1 0");
    odrive_serial.print('\n');
}
...
// Clear errors
void odrive_clear_errors()
{
    odrive_serial.print("sc");
    odrive_serial.print('\n');
}

// Change velocity ramp
void odrive_set_velocity_ramp(double velocity_ramp)
{
    odrive_serial.print("w axis0.controller.config.vel_ramp_rate ");
    odrive_serial.print(velocity_ramp);
    odrive_serial.print('\n');
    odrive_serial.print("w axis1.controller.config.vel_ramp_rate ");
    odrive_serial.print(velocity_ramp);
    odrive_serial.print('\n');
}

// Change Velocity Ramp
void odrive_set_input_mode(int mode)
{
    odrive_serial.print("w axis0.controller.config.input_mode ");
    odrive_serial.print(mode);
    odrive_serial.print('\n');
    odrive_serial.print("w axis1.controller.config.input_mode ");
    odrive_serial.print(mode);
    odrive_serial.print('\n');
}
...
{
    odrive_serial.print("w axis0.requested_state 3");
    odrive_serial.print('\n');
    odrive_serial.print("w axis1.requested_state 3");
    odrive_serial.print('\n');
}
