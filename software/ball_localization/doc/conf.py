...
htmlhelp_basename = 'ball_localizationdoc'
...
latex_documents = [
    (master_doc, 'ball_localization.tex', u'robot\\_localization Documentation',
     u'Tom Moore', 'manual'),
]
...
man_pages = [
    (master_doc, 'ball_localization', u'ball_localization Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ball_localization', u'ball_localization Documentation',
     author, 'ball_localization', 'One line description of project.',
     'Miscellaneous'),
]
